...
# purpose: load the ImageNet vgg19 model
# output: vgg19 model
# side effect: download the model
def load_vgg19():
    # load the vgg19 model
    train_data = models.vgg19(weights=models.VGG19_Weights.DEFAULT)
    # change the ReLU
...
# purpose: normalize image based on ImageNet mean and standard deviation
# output: normalized image for ImageNet vgg19
...
def make_perceptual_loss(select_layer, max_layer, mse_weight):
    ...
    def loss_function(model, X, Y, train_data):
        ...
        predict_feature = normalize_for_vgg(prediction.clamp(0, 1))
        target_feature = normalize_for_vgg(Y.clamp(0, 1))
...
def train_one_model(model, train_loader, validation_loader, train_data, loss_function, learning_rate):
    ...
    save_epochs = [1, num_epochs//2, num_epochs//2 + num_epochs//4, num_epochs]
...
def run_layer_comparison():
    ...
    layer_choice = {
        "texture_0_9": {"select_layer": (0, 2, 5, 7), "max_layer": 8, "mse_weight": 0.05, "learning_rate": 0.0005},
        "structure_10_18": {"select_layer": (10, 12, 14 ,16), "max_layer": 17, "mse_weight": 0.05, "learning_rate": 0.0005},
        "semantic_19_27": {"select_layer": (19, 21, 23, 25), "max_layer": 26, "mse_weight": 0.05, "learning_rate": 0.0005},
        "deep_semantic_28_34": {"select_layer": (28, 30, 32, 34), "max_layer": 35, "mse_weight": 0.05, "learning_rate": 0.0005},
        "multiple_10_32": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 33, "mse_weight": 0.05, "learning_rate": 0.0005}
    }
    result = {}
    models = {}
...
def run_mse_weight_comparison():
    ...
    mse_weight_choice = {
        "mse_weight_0": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 33, "mse_weight": 0.00, "learning_rate": 0.0005},
        "mse_weight_5": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 33, "mse_weight": 0.05, "learning_rate": 0.0005},
        "mse_weight_20": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 33, "mse_weight": 0.20, "learning_rate": 0.0005},
        "mse_weight_40": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 33, "mse_weight": 0.40, "learning_rate": 0.0005}
    }
    result = {}
    models = {}
    epoch_output = {}
...
def run_learning_rate_comparison():
    ...
    learning_rate_choice = {
        "learning_rate_0001": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 35, "mse_weight": 0.05, "learning_rate": 0.0001},
        "learning_rate_0005": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 35, "mse_weight": 0.05, "learning_rate": 0.0005},
        "learning_rate_005": {"select_layer": (5, 10, 14, 19, 21, 23, 25, 32), "max_layer": 35, "mse_weight": 0.05, "learning_rate": 0.005}
    }
    result = {}
    models = {}
...
def main():
    ...
    save_summary_table(layer_result=layer_result, mse_weight_result=mse_weight_result, learning_rate_result=learning_rate_result,
                       save_path="flower_perceptual_hyperparameter_table.png")
    # save qualitative result figure for layer comparison
    plot_qualitative_figure(model_lst=layer_model, test_loader=layer_test_loader, model_keys=["texture_0_9", "structure_10_18", "semantic_19_27", "deep_semantic_28_34", "multiple_10_32"],
        image_count=5, title="Flower feature layers comparison figure", save_path="flower_perceptual_layer_qualitative.png")
    # save qualitative result figure for MSE comparison
    plot_qualitative_figure(model_lst=mse_weight_model, test_loader=mse_weight_test_loader, model_keys=["mse_weight_0", "mse_weight_5", "mse_weight_20", "mse_weight_40"], 
        image_count=5, title="Flower MSE weights comparison figure", save_path="flower_mse_comparison_qualitative.png")
    # save qualitative result figure for learning rate comparison
    plot_qualitative_figure(model_lst=learning_rate_model, test_loader=learning_rate_test_loader, model_keys=["learning_rate_0001", "learning_rate_0005", "learning_rate_005"], 
        image_count=5, title="Flower learning rate comparison figure", save_path="flower_learning_rate_qualitative.png")
    # save epoch qualitative result figure for one experiment with learning rate = 0.0005, layers = 5, 10, 14, 19, 21, 23, 25, 32, weights = 0.05
    plot_epoch_qualitative_figure(epoch_model=mse_weight_epoch_model["mse_weight_5"], test_loader=mse_weight_test_loader, image_count=5,
        title="Flower qualitative results at different epochs", save_path="flower_epoch_qualitative.png")
